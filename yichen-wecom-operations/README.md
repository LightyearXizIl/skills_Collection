...
Original files in this directory follow the [Personal Learning and Non-Commercial Use License](./LICENSE.upstream). The external [`WeComTeam/wecom-cli`](https://github.com/WecomTeam/wecom-cli) runtime is maintained separately by WeComTeam under its own MIT License; no upstream CLI source or binary is vendored here.
